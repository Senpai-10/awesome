...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "e", function () awful.spawn(files_manager) end,
    ...
    awful.key({ modkey, "Control"  }, "p", function() awful.spawn("flameshot gui") end,
              {description = "screenshot with selection", group = "scrot"}),

    awful.key({ modkey, "Shift" }, "p", function() awful.spawn.with_shell("gpick -o -s | xclip -sel c") end,
              {description = "color picker", group = "awesome"}),

    awful.key({ modkey, "Control"  }, "s", function() awful.spawn("flameshot full") end,
              {description = "screenshot fullscreen", group = "scrot"}),

    awful.key({ modkey, "Control", "Shift"  }, "s", function() awful.spawn("flameshot full -c") end,
              {description = "screenshot fullscreen and save to clipboard", group = "scrot"}),
    ...
    awful.key({}, "XF86AudioRaiseVolume", function () awful.spawn("playerctl-wrapper volume 0.2+") end,
            {description = "raise volume", group = "function keys"}),

    awful.key({}, "XF86AudioLowerVolume", function () awful.spawn("playerctl-wrapper volume 0.2-") end,
            {description = "lower volume", group = "function keys"}),

    awful.key({}, "XF86AudioMute", function () awful.spawn("playerctl-wrapper volume 0.0") end,
            {description = "mute audio", group = "function keys"}),

    awful.key({}, "XF86AudioPlay", function () awful.spawn("playerctl-wrapper play-pause") end,
            {description = "play audio", group = "function keys"}),

    awful.key({}, "XF86AudioStop", function () awful.spawn("playerctl-wrapper stop") end,
            {description = "stop audio", group = "function keys"}),

    awful.key({}, "XF86AudioNext", function () awful.spawn("playerctl-wrapper next") end,
        {description = "play next audio", group = "function keys"}),

    awful.key({}, "XF86AudioPrev", function () awful.spawn("playerctl-wrapper previous") end,
        {description = "play previous audio", group = "function keys"}),

    awful.key({}, "XF86Tools", function() awful.spawn(terminal .. " -e " .. music_player) end,
               {description = "launch music player", group = "function keys"}),

    awful.key({}, "XF86Calculator", function() awful.spawn("gnome-calculator") end,
               {description = "launch calculator", group = "function keys"})
