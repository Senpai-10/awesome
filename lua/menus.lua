...
local menu_applications = {
    ...
    {
        "gnome-system-monitor", function()
            awful.spawn.with_shell("gnome-system-monitor")
        end
    },
    {
        "system-monitoring-center", function()
